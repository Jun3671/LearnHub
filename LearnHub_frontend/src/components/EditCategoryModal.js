...
function EditCategoryModal({ isOpen, onClose, onSuccess, category }) {
  ...
  return (
    <div className="fixed inset-0 bg-neutral-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-white rounded-xl shadow-modal max-w-md w-full animate-scale-in overflow-hidden">
        {/* Header */}
        <div className="bg-white border-b border-neutral-200/60 px-6 py-4 flex items-center justify-between rounded-t-xl">
          <h2 className="text-xl font-semibold text-neutral-900">카테고리 수정</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {/* Category Name */}
          <div>
            <label htmlFor="categoryName" className="block text-sm font-semibold text-neutral-700 mb-2 tracking-wide">
